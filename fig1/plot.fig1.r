...
par (new = TRUE)
plot (unlist (sum ['wikilinks-complete',]), col = 'blue', xaxt = 'n', ylim = c (0, max_sum), ylab = '', xlab = '')
par (new = TRUE)
plot (unlist (sum ['twitter_compressed',]), col = 'green', xaxt = 'n', ylim = c (0, max_sum), ylab = '', xlab = '')
par (new = TRUE)
...
par (new = TRUE)
plot (unlist (active ['wikilinks-complete', ]), col = 'blue', xaxt = 'n', ylim = c (0, max_active), ylab = '', xlab = '')
par (new = TRUE)
plot (unlist (active ['twitter_compressed', ]), col = 'green', xaxt = 'n', ylim = c (0, max_active), ylab = '', xlab = '')
par (new = TRUE)
...
par (new = TRUE)
plot (unlist (uniqueness ['wikilinks-complete', ]), col = 'blue', xaxt = 'n', ylim = c (0, max_uniqueness), ylab = '', xlab = '')
par (new = TRUE)
plot (unlist (uniqueness ['twitter_compressed', ]), col = 'green', xaxt = 'n', ylim = c (0, max_uniqueness), ylab = '', xlab = '')
par (new = TRUE)
