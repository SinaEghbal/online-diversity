...
mylabel <- function(txt) label(txt, -0.3, 1.15, xpd=NA, cex=1.5)
...
pdf ('fig1-pub.pdf', height=9, width=3)
par(mfrow=c(3,1), oma=c(4,4,0,1), mar=c(2,2,4,0))

plot(as.date1(posts [1, ]),posts [1, ], type = 'l', ylab = '# posts per month (?)', xlab = '', yaxt = 'n', col = cols[1], log = "y",
