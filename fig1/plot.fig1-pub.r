...
load(file = "../HHI-powerlaw-fits/data/2016-04-15-twitter-total-diversity-decline.dat")
points (as.date3(HHI), HHI, col = cols[1], type = 'l', lwd=2)
mtext("Year", 1, cex=1.2, line=3)
mtext("HHI", 2, cex=0.9, line=3)
mylabel("D - HHI/Simpson's diversity index")
